...
if (gallery) {
  ...
  new PhotoSwipeDynamicCaption(lightbox, {
    ...
    captionContent: (slide) => {
      ...
      const r2url = el.dataset.r2url || "";
      let caption = title ? `<span>${title}</span>` : "";
      if (r2url) {
        caption += `${caption ? "<br>" : ""}<a href="${r2url}" target="_blank" rel="noopener">⬇ Volle Auflösung herunterladen</a>`;
      }
      return caption;
    },
  });
